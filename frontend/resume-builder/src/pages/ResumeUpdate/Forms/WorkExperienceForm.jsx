...
<div className='px-5 pt-5'>
    ...
    <div className='mt-4 flex flex-col gap-4 mb-3'>
            ...
            <div key={index} className='border border-gray-200/80 p-4 rounded-lg relative'>
...

                {
                    workExperience.length > 1 && (
                        <button type='button' className='absolute top-3 text-sm text-red-600 hover:underline cursor-pointer' onClick={()=>removeArrayItem(index)}>
                            <LuTrash2/>
                        </button>
                    )
                }
        ...
        <button type='button' className='self-start flex items-center gap-2 px-4 py-2 rounded bg-blue-100 text-blue-800 text-sm font-medium hover:bg-blue-200 cursor-pointer' 
