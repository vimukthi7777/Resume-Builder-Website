    ...
    <div className='mt-6'>
        ...
        <div className='flex flex-col gap-4'>
            {languages?.map((lang, index) => (
               ...
               <button type='button' className='self-start flex items-center gap-2 px-4 py-2 rounded bg-blue-100 text-blue-800 text-sm font-medium hover:bg-blue-200 cursor-pointer' onClick={() => addArrayItem("languages", {name: "", progress:0})}>
                    <LuPlus/> Add Language
               </button> 
        </div>
    </div>
            ...
            <div className='mt-8 mb-4'>
                ...
                <div className='flex flex-col'>
                    ...
                    <button type='button' className='self-start flex items-center gap-2 px-4 py-2 rounded bg-blue-100 text-blue-800 text-sm font-medium hover:bg-blue-200 cursor-pointer' onClick={() => addArrayItem("interests", "")}>
                        <LuPlus/> Add Interest
                    </button>
