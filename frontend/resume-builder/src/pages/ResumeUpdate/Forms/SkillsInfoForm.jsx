...
const SkillsInfoForm = ({skillsInfo, updateArrayItem, addArrayItem, removeArrayItem}) => {
  return (
    <div className='px-5 pt-3'>
      ...
      <div className='mr-4 flex flex-col gap-4 mb-3'>
        {skillsInfo.map((skill, index) => (
            ...
            <button className='self-start flex items-center gap-2 px-4 py-2 rounded bg-blue-100 text-blue-800 text-sm font-medium hover:bg-blue-200 cursor-pointer' onClick={() => addArrayItem({name: '', progress:0,})}>
                <LuPlus/>Add Skill
            </button>
      </div>
    </div>
