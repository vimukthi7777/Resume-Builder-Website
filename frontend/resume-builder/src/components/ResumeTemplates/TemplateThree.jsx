...
const TemplateThree = ({resumeData, colorPalette, containerWidth}) => {
  ...
  return <div
            ...
            style={{transform: containerWidth > 0 ? `scale(${scale})` : 'none',
              transformOrigin:"top left",
              width: containerWidth > 0 ? `${baseWidth}px` : "auto", //keep the original size 
              height: "auto"
            }}  
            >

            <div className='flex items-start gap-5 px-2 mb-5'> 
                <div className='w-[100px] h-[100px] max-w-[105px] max-h-[105px] rounded-2xl flex items-center justify-center' style={{backgroundColor: themeColors[1] }}>
                    {resumeData.profileInfo.profilePreviewUrl ? (
                        <img src={resumeData.profileInfo.profilePreviewUrl} className='w-[90px] h-[90px] rounded-2xl'/>
                    ) : (
