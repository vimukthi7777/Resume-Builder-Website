...
const RatingInput = ({value, total, onChange = () => {}, color ="#2563EB" ,bgColor="#D4E4FF"}) => {
 //Convert 0-100 to 0-5 scale
    ...
    return <div className='flex gap-3 cursor-pointer'>
        {[...Array(total)].map((_,index) => {
            ...
            return (
                <div key={index} onClick={() => handleClick(index)} className='w-4 h-4 rounded transition-all' style={{backgroundColor: isActive ? color:bgColor,}}>
